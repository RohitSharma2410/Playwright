...
public class LoginPage {
	...
	public Locator getUsername() {
		return base.getLandingPage().locator(base.getPageObjects().getprop().get("username").toString());
	}

	public Locator getPassword() {
		return base.getLandingPage().locator(base.getPageObjects().getprop().get("password").toString());

	}

	public Locator getLoginButton() {
		return base.getLandingPage().locator(base.getPageObjects().getprop().get("login-button").toString());
	}
